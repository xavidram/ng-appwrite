...
export class AppwriteStorage extends AppwriteService {
  /**
   * List Files
   *
  ...
  async getFile(fileId: string): Promise<string> {
    let path = '/storage/files/{fileId}'.replace(
      new RegExp('{fileId}', 'g'),
      fileId
    );
  ...
  async getFilePreview(
    ...
    let path = '/storage/files/{fileId}/preview'.replace(
      new RegExp('{fileId}', 'g'),
      fileId
    );
  ...
  async getFileView(fileId: string, as: string = ''): Promise<string> {
    let path = '/storage/files/{fileId}/view'.replace(
      new RegExp('{fileId}', 'g'),
      fileId
    );
